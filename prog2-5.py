...
model = tf.keras.models.Sequential([
    ...
    #tf.keras.layers.Conv1D(filters=3,kernel_size=3,activation = tf.nn.relu, input_shape=(m,n)),
...
print("train")
model.fit(x_train, y_train, epochs=650, batch_size=100)
...
print("evaluate prog1-5.py model")
